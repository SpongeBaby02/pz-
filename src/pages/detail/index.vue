    ...
    <div class="container">
        ...
        <div class="tips">
            <div class="dzf" v-if="detailData.trade_state=== '待支付'">
                ...
                <div class="text2">
                    请在 <counter :second="second" /> 内完成支付，违时将自动取消
                </div>
                <div class="text3">
            ...
            <div class="dzf" v-if="detailData.trade_state=== '待服务'">
                ...
                <div class="text2">请保持手机畅通，稍后有服务人员与您联系</div>
            </div>
            <div class="ywc" v-if="detailData.trade_state=== '已完成'">
                <div class="text1">服务已完成</div>
                <div class="text2">感谢您的使用，如有问题请与售后人员联系</div>
            </div>
...
onMounted (async () => {
    ...
    Object.assign(detailData,data.data)//合并数据
